...
const CheckoutPage = () => {
  ...
  const mockPixCode = "00020126580014br.gov.bcb.pix0136acaiohana-pix-key-placeholder5204000053039865802BR5925ACAI OHANA ACAITERIA6008SAOPAULO62070503***6304ABCD";
